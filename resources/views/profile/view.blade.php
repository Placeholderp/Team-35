<x-app-layout>
    <!-- Main container with Alpine.js initialization. -->
    <div x-data="{
            // Retrieve flash message from the session (if any)
            flashMessage: '{{\Illuminate\Support\Facades\Session::get('flash_message')}}',
            // On initialization, dispatch a 'notify' event if a flash message exists
            init() {
        ...
        <!-- Grid layout for the profile update form and password update form -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            
            <!-- Profile & Address Update Form (spanning 2 columns on medium screens) -->
            <div class="bg-white p-3 shadow rounded-lg md:col-span-2">
                <!-- Form with Alpine.js state for addresses and countries -->
                <form x-data="{
                    // List of countries passed from the backend
                    countries: {{ json_encode($countries) }},
                    // Billing address data with fallback to old input or current billing address
                    ...
                    // Shipping address data with fallback to old input or current shipping address
                    ...
                    // Computed property: Returns states for the selected billing country, if available.
                    ...
                    // Computed property: Returns states for the selected shipping country, if available.
                    ...
                    <!-- First Name and Last Name Inputs in a 2-column grid -->
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        ...
                        <!-- State Selection/Input for Billing -->
                        <div>
                            <!-- If states are available for the selected country, render a select -->
                            ...
                            <!-- Otherwise, render a text input for state -->
                            <template x-if="!billingCountryStates">
                                <x-input
                                    type="text"
                                    name="billing[state]"
                    ...
                    <!-- Shipping Address Section with option to copy billing address -->
                    <div class="flex justify-between mt-6 mb-2">
                        <h2 class="text-xl font-semibold">Shipping Address</h2>
                        <label for="sameAsBillingAddress" class="text-gray-700">
                            <!-- Checkbox to copy billing address into shipping address -->
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        ...
                        <!-- Shipping State Selection/Input -->
                        <div>
