    ...
    <section id="about-container" class="container pt-5">
        ...
        <div class="row mb-5">
            <div class="col-lg-6 col-md-6 col-12">
                <img class="w-100 img-fluid" src="{{ asset('Images/about_image.png') }}" alt="About image">
            </div>
            <div class="col-lg-6 col-md-6 col-12 d-flex flex-column justify-content-center">
                ...
                <p>
                At Aston35 Fitness, we believe that everyone deserves the tools and support 
                to reach their full potential. Founded in 2025, our journey began with a simple 
                commitment: to provide premium proteins, supplements, and workout plans that
                 empower individuals to live healthier, stronger lives. Day by day, we've 
                 grown into a trusted community of fitness enthusiasts, delivering exceptional 
                 results and championing personal transformation.


                </p>
                <p>
                Since our early beginnings, our dedication to quality and innovation 
                has fueled our passion. From cutting-edge supplements to targeted 
                fitness programs, we constantly push boundaries to bring you the 
                very best in health and wellness.
                </p>
            </div>
        </div>
        ...
        <div class="row mb-5">
            <div class="col-12">
                <img class="w-100 img-fluid" src="{{ asset('Images/ASTON 35.png') }}" alt="About banner">
            </div>
        </div>
        ...
        <div class="row mb-5">
            ...
            <div class="post col-lg-4 col-md-6 col-12 pb-5">
                <div class="post-img">
                    <img class="w-100 img-fluid" src="{{ asset('/Images/Member3.png') }}" alt="Team Member">
                </div>
            ...
            <div class="post col-lg-4 col-md-6 col-12 pb-5">
                <div class="post-img">
                    <img class="w-100 img-fluid" src="{{ asset('/Images/Member2.png') }}" alt="Team Member">
                </div>
            ...
            <div class="post col-lg-4 col-md-6 col-12 pb-5">
                <div class="post-img">
                    <img class="w-100 img-fluid" src="{{ asset('/Images/Member1.png') }}" alt="Team Member">
                </div>
