...
function addCartClicked(event) {
    ...
    var shopProducts = button.closest(".product-info");

    var title = shopProducts.getElementsByClassName("product-title")[0].innerText;
    var price = shopProducts.getElementsByClassName("price")[0].innerText;
    var productImg = document.getElementById("product-image").src;
...
function addProductToCart(title, price, productImg, quantity = 1) {
    ...
    var cartBoxContent = `
        <img src="${productImg}" alt="" class="cart-img basket-page-img" />
