...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (profileIcon && profileDropdown) {
        ...
        // Closes the dropdown when it is not in focus
    ...
    if (searchIcon && searchInput) {
        ...
        // Closes search when it is not in focus
        document.addEventListener('click', function(e) {
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-5">
            <div class="order-summary p-4 bg-light rounded">
                ...
                <div id="cart-items">
                    <!-- Items stored in the cart will be put into this section -->
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            ccNumberInput.addEventListener('input', function(e) {
                // Filters and removes non-digits
                ...
                // Automatically  adds a space after every 4 digits
                let formattedValue = '';
            ...
            expirationInput.addEventListener('input', function(e) {
                ...
                // Format as MM/YY
                if (value.length > 0) {
                    // Limits to months (limit to 01-12)
            ...
            checkoutForm.addEventListener('submit', function(e) {
                ...
                // Validate all the credit card fields if user selects credit card
...
// If the form is valid, the payment goes through and into processing
if (checkoutForm.checkValidity()) {
    // Order becomes a success
